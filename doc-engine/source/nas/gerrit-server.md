...
This guide covers setting up a git server on your UGREEN NAS for small team collaboration. We'll start with simple bare
repos via SSH, then evolve to full Gerrit code review if needed.
...
1. Check NAS `/home/git/.ssh/authorized_keys`:
