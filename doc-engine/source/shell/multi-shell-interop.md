...
The dotfiles include pre-built fish launcher functions in `fish/conf.d/shell-launchers.fish`. These wrap bash/zsh with
...
6. Bash reads new history from file before prompt (shared history across bash sessions)
7. You get full history access in bash
